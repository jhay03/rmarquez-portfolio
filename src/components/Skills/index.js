      ...
      <div className="row">
        <div className="col-lg-12 text-center services-title">
          <div className="skills-title">
            <h1
              className="wow fadeInDown text-uppercase title-text"
              data-wow-delay="1s"
            >
              Skills
            </h1>
        ...
        <div className="container services-list">
          <div className="row">
            <div className="col-lg-3 col-md-6 col-sm-12">
              <div
                className="wow fadeInUp services h-100"
                data-wow-delay="1.5s"
              >
                ...
                <div className="card-body text-center">
                  ...
                  <p className="card-text text-secondary">
                    Frontend Frameworks and Libraries : Bootstrap,
                    Jquery,ReactJS, Sass, ReactJS
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12">
              <div
                className="wow fadeInDown services h-100"
                data-wow-delay="1.5s"
              >
                <div className="services-img text-center ">
